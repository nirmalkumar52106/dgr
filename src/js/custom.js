export default function Customjs() {
    ...
    $(".about-menu").hover(function() {
        $(".about-mm").stop(true, true).fadeIn();
    }, function() {
        $(".about-mm").stop(true, true).fadeOut();
    });

    $(".admi-menu").hover(function() {
        $(".admi-mm").stop(true, true).fadeIn();
    }, function() {
        $(".admi-mm").stop(true, true).fadeOut();
    });

    $(".cour-menu").hover(function() {
        $(".cour-mm").stop(true, true).fadeIn();
    }, function() {
        $(".cour-mm").stop(true, true).fadeOut();
    });
